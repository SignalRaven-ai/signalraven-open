...
export const getSignal = createAction({
  ...
  description: 'Fetch one signal: the person, ICP analysis, why it matters, suggested opener and talking points.',
  audience: 'both',
  aiMetadata: { description: 'Fetches a single SignalRaven signal by id, including the person, ICP analysis, why it matters, the suggested opener and talking points. Get the id from List Signals or the New Signal trigger.' },
  props: {
